  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ease-out ${navStyle} ${
        navStyle === "navbar-scrolled" ? "bg-[#1C1C22] shadow-md" : "bg-transparent"
      }`}
    >
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <ul
          ...
          } md:flex space-x-6 md:space-y-0 space-y-2 md:space-x-6 text-white text-[18px] font-semibold md:bg-transparent bg-gray-100 md:static absolute top-full left-0 w-full md:w-auto px-4 py-2 md:p-0`}
        >
          <li>
